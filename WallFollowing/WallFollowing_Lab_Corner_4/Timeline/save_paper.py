...
LastEditTime : 2023-09-10 22:29:16
FilePath     : /WallFollowing_Lab_Corner_4/Timeline/save_paper.py
Description  : 
"""
import cv2
import numpy as np
...
def extract_keypoints(video):
    ...
    with tqdm(total=MAX_FRAMES + 500) as pbar:
        while cap.isOpened() and k < MAX_FRAMES + 501:
