...
<<<<<<< HEAD:WallFollowing/WF_LEFT_1/Timeline/Save.py
if os.path.exists("../corner.mp4") == False:
    VIDEO = "corner.mp4"
else:
    VIDEO = "../corner.mp4"
=======
VIDEO = "test_corner.mp4"
>>>>>>> 16893f4755d8d0099c3160a887796aa5bad59676:WallFollowing/WF_Plots/Temp/save.py
...
<<<<<<< HEAD:WallFollowing/WF_LEFT_1/Timeline/Save.py
        decriptor_path = "side_demo_kpt_des_" + str(INTERVAL) + "_" + str(MAX_MATCH_DISTANCE) + "/side_demo_kpt_des%d.yml"%(i+1)
        if os.path.exists("side_demo_" + str(INTERVAL) + "_" + str(MAX_MATCH_DISTANCE)) == False:
            os.mkdir("side_demo_" + str(INTERVAL) + "_" + str(MAX_MATCH_DISTANCE))
        demo_path = "side_demo_" + str(INTERVAL) + "_" + str(MAX_MATCH_DISTANCE) + "/side_demo%d.mp4"%(i+1)
        analyze_kpt_des(frames, frame_kpt, frame_des, decriptor_path, demo_path)
=======
