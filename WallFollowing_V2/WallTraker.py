...
LastEditTime : 2023-08-13 17:57:50
FilePath     : /WallFollowing_V2/WallTraker.py
...
### Constants ###   
DEMO_VIDEO = "sidedemo.mp4"                       # The path to the demo video
...
class WallTraker:
    ...
    def show_all_frames(self) -> None:
        ...
        cv2.moveWindow("Robot", 0, 100)       # Position the "Robot" window at (100, 100)
        cv2.moveWindow("Donkey", 400, 100)      # Position the "Donkey" window at (600, 100)
        cv2.moveWindow("Carrot", 800, 100)     # Position the "Carrot" window at (1100, 100)
